...
<div class="bg-white dark:bg-slate-800 rounded-lg p-6 ring-1 ring-slate-900/5 shadow-xl">
    <div class="flex justify-between items-center m-3">
        ...
        <a href="{{ route('admin.payout-methods.create') }}" class="mt-4 inline-block px-4 py-2 bg-indigo-500 text-white rounded-md">Add New Method</a>
    </div>
    @if (session('success'))
            ...
            @foreach ($payoutMethods as $method)
                <tr class="border-b">
                    ...
                    <td class="py-2">
                        ...
                        <form action="{{ route('admin.payin_methods.destroy', $method->id) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
