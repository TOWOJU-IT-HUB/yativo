<aside :class="sidebarToggle ? 'translate-x-0' : '-translate-x-full'"
    ...
    <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <a href="index.html">
            <img src="{{ url('assets') }}/src/images/logo/logo.svg" alt="Logo" />
        </a>
    ...
    <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            ...
                            @click="selected = (selected === 'Currencies' ? '':'Currencies')"
                            :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Currencies') && (page === 'Currencies') }"
                            :class="page === 'Currencies' && 'bg-graydark'">
                            <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            href="{{ route('admin.payin_methods.index') }}"
                            @click="selected = (selected === 'Profile' ? '':'Profile')"
                            :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Profile') && (page === 'profile') }"
                            :class="page === 'profile' && 'bg-graydark'">
                            <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none"
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            href="{{ route('admin.exchange_rates.index') }}"
                            @click="selected = (selected === 'Profile' ? '':'Profile')"
                            :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Profile') && (page === 'profile') }"
                            :class="page === 'profile' && 'bg-graydark'">
                            <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none"
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            href="{{ route('admin.deposits.index') }}" @click.prevent="selected = (selected === 'deposits' ? '':'deposits')"
                        ...
                        <div class="translate transform overflow-hidden"
                            :class="(selected === 'deposits') ? 'block' : 'hidden'">
                            <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="{{ route('admin.deposits.index') }}"
                                        :class="page === 'formElements' && '!text-white'">All Deposits</a>
                                </li>
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="{{ route('admin.deposits.index') }}?status=pending" :class="page === 'formLayout' && '!text-white'">Pending Deposits</a>
                                </li>
                            </ul>
                        </div>
                        <!-- Dropdown Menu End -->
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            href="{{ route('admin.payouts.index') }}" @click.prevent="selected = (selected === 'Forms' ? '':'Forms')"
                            :class="{
                            ...
                            <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        ...
                                        :class="page === 'formElements' && '!text-white'">All Withdrawals</a>
                                </li>
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                        href="{{ route('admin.payouts.index') }}?status=pending" :class="page === 'formLayout' && '!text-white'">Pending Withdrawals</a>
                                </li>
                            </ul>
                        </div>
                        <!-- Dropdown Menu End -->
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                            href="{{ route('admin.settings.index') }}" @click="selected = (selected === 'Settings' ? '':'Settings')"
                            :class="{
        ...
        <div
            ...
            <h3 class="mb-1 font-semibold text-white">YativoAdmin</h3>
            <p class="mb-4 text-xs">//</p>
