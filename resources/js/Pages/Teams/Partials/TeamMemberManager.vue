    ...
    <div>
        <div v-if="userPermissions.canAddTeamMembers">
            ...
            <FormSection @submitted="addTeamMember">
                ...
                <template #description>
                    Add a new team member to your business, allowing them to collaborate with you.
                </template>

                <template #form>
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600">
                            Please provide the email address of the person you would like to add to this business.
                        </div>
                    </div>
        ...
        <div v-if="team.team_invitations.length > 0 && userPermissions.canAddTeamMembers">
            ...
            <ActionSection class="mt-10 sm:mt-0">
                ...
                <!-- Pending Business Member Invitation List -->
                <template #content>
                    <div class="space-y-6">
        ...
        <div v-if="team.users.length > 0">
            ...
            <ActionSection class="mt-10 sm:mt-0">
                ...
                <template #description>
                    All of the people that are part of this business.
                </template>
        ...
        <ConfirmationModal :show="confirmingLeavingTeam" @close="confirmingLeavingTeam = false">
            ...
            <template #content>
                Are you sure you would like to leave this business?
            </template>
        ...
        <!-- Remove Business Member Confirmation Modal -->
